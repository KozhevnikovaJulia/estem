...
export const attributesArr: Array<attributesArrItem> = [
  ...
  { mainAttrute: 'СМИ', attributeNameForMedia: 'ТВ', attributes: ['СМИ', 'Национальная телекомпания', 'Телекомпания', 'Телекомпания оригинала'] },
  { mainAttrute: 'СМИ', attributeNameForMedia: 'Радио', attributes: ['СМИ', 'Холдинг', 'Радиостанция'] },
  { mainAttrute: 'СМИ', attributeNameForMedia: 'Пресса', attributes: ['СМИ', 'Издательский дом', 'Издание'] },
  { mainAttrute: 'СМИ', attributeNameForMedia: 'ООН', attributes: ['СМИ', 'Сеть', 'Агентство'] },
  { mainAttrute: 'СМИ', attributeNameForMedia: 'Интернет', attributes: ['СМИ', 'Площадка', 'Рекламная сетка'] },
];
